...
export default Ember.Component.extend({
  populateDictionaryAndSetExistingValues: function() {
    ...
    let currentCountryCode = 'PT'; //this.get('operator.country'); <-- TODO remove testing value
    let currentStateCode = 'PT-11'; //this.get('operator.state');  <-- TODO remove testing value
